<div class="row">
    ...
    <div class="col-md-6 fs-8 mb-3">
        ...
        <div class="d-flex align-items-center">
            <div class="p-6 bg-primary-subtle rounded-circle me-2 d-flex align-items-center justify-content-center">
                <i class="ti ti-address-book text-primary fs-8"></i>
            </div>
            <div class="">
    ...
    <div class="col-md-6 text-end">
        ...
        <a class="btn mb-1 btn-rounded btn-light text-dark font-medium text-dark" data-bs-toggle="tooltip" title="Settings" href="/settings/clients">
...
<div class="row">
    <div class="col-12 card py-3">
        <div class="row">
            <div class="col-md-6">
                <a href="contacts/create" class="btn bg-primary-subtle ms-2">
            ...
            <div class="col-md-6 text-end">
                <div class="input-group">
                    ...
                    @else
                        ...
                        <!-- <button class="btn bg-secondary-subtle text-secondary" type="button" data-bs-toggle="offcanvas" data-bs-target="#filterOffcanvas" aria-controls="filterOffcanvas" data-request="onShowFilters" {{ $data['search'] != "" ? 'disabled' : '' }}>
                            <i class="ti ti-adjustments"></i>
                            {{ 'Filter' }}
                        </button> -->
                    @endif
